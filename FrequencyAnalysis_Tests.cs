...
namespace TextAnalysis
{
    ...
    public class FrequencyAnalysis_Tests
    {
        ...
        // [Test]
        // [Order(00)]
        // public void ReturnEmptyDictionary_OnStone()
        // {
        //     var text = "sorcerer's stone, a. sorcerer's stone if. sorcerer's stone against. sorcerer's stone and. sorcerer's stone apart.";
        ...
        // [Test]
        // [Order(70)]
        // public void HarryPotterCheck()
        // {
        //     var text = System.IO.File.ReadAllText(@"/Users/ilya/Downloads/TextAnalysis.csproj/HarryPotterText.txt");
        //     var parsedText = SentencesParserTask.ParseSentences(text);
        //     var expected = new Dictionary<string, string>
        //     {
        //     
